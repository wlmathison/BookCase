...
namespace BookCase.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var applicationDbContext = _context.Books.Include(b => b.Author).Include(b => b.Genre).Include(b => b.Owner).Where(b => b.OwnerId == currentUser.Id);
        ...
        public async Task<IActionResult> Create([Bind("Id,ISBN,Title,AuthorId,GenreId,DatePublished,OwnerId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ISBN,Title,AuthorId,GenreId,DatePublished,OwnerId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
